...
<body>
 ...
 <!-- Header -->
  ...
  <!-- Parallax -->
    <div class="block bg-primary block-pd-lg block-bg-overlay text-center" data-bg-img="assets/images/parallax-bg.jpg" data-settings='{"stellar-background-ratio": 0.6}' data-toggle="parallax-bg" style="background: url('<?php echo base_url();?>assets/cpanel/images/page_bg.jpg');">
      <h2>
        Browse Courses 
      </h2>
    ...
    <section class="breadcrumb" id="breadcrumb">
      ...
      <?php $this->load->view('template/includes/sidebar');?>
    ...
    <script type="text/javascript">
      $(function() { 
        ...
        //   if (d != c)
        //   {
        //     $('#error_num').html() ="Invalid Number. Please Add Two Number Accordingly";
        //     return false;
        //   }
        // }
        // function checknum() {
