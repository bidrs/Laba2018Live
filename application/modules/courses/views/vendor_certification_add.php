<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
        ...
        <div class="bor">
          <form action="<?php echo base_url('courses/vendor_certification_upload');?>" method="POST">
            <div class="row">
              <div class="input-field col s12">
                <input id="c_title" type="text" class="validate" name="title" maxlength="150" required placeholder="eg: Microsoft Certified Solutions Associate">
                <label for="c_title">Certification Title</label>
              </div>
              <div class="input-field col s12">
                <input id="abbre" type="text" class="validate" name="short" maxlength="60" required placeholder="eg: MCSA">
