...
<!-- Mirrored from rn53themes.net/themes/demo/lava-admin/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2017 10:53:52 GMT -->
<head>
    <title>Laba Nepal | Forget</title>
    <!--== META TAGS ==-->
    <meta charset="utf-8">
    ...
    <div class="blog-login">
        <div class="blog-login-in">
            <form>
                ...
                <a href="<?php echo base_url('laba_cpanel');?>" class="for-pass">Login</a>
            </form>
        </div>
    </div>
